    ...
    return (
        <>
            <div id="heroBanner" className="r flex fullW borrad15 boxedEl1 pad30 martom30 hideOverflow centerHori centerVerti">
                ...
                <div className="flex verti fullW gap5 z2 padtop30" style={{"justify-content": "end"}}>
            ...
            <div className="flex spaceAroundH bortom1" style={{"height": "auto", "padding-bottom": "60px", "overflow": "auto"}}>
                ...
                <div className="flex verti fullH gap10 centerHori centerVerti pad30 borrad15" style={{"width" : "200px"}}>
                    <svg width="" height="" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M86.2402 113.759L92.7986 92.801L113.757 86.2427L107.199 107.197L86.2402 113.759Z" stroke="#4A3529" stroke-width="7.74177" stroke-linecap="round" stroke-linejoin="round" style={{"mix-blend-mode":"hard-light"}}/>
                    </svg>
                ...
                <div className="flex verti fullH gap10 centerHori centerVerti pad30 borrad15" style={{"width" : "200px"}}>
                    <svg width="" height="" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M105.125 92.5625H117.95" stroke="#433833" stroke-width="6.9375" stroke-linecap="round" stroke-linejoin="round" style={{"mix-blend-mode":"hard-light"}}/>
                ...
                <div className="flex verti fullH gap10 centerHori centerVerti pad30 borrad15" style={{"width" : "200px"}}>
                    <svg width="" height="" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M100.316 118.266V105.893" stroke="#2A2A2A" stroke-width="7.0625" stroke-linecap="round" stroke-linejoin="round"style={{"mix-blend-mode":"hard-light"}}/>
                        <path d="M143.296 94.54L143.159 94.6389C131.756 101.664 116.699 105.906 100.295 105.906C83.8909 105.906 68.8761 101.664 57.4772 94.6389L57.3359 94.54" stroke="#2A2A2A" stroke-width="7.0625" stroke-linecap="round" stroke-linejoin="round" style={{"mix-blend-mode":"hard-light"}}/>
                        ...
                        <path d="M115.679 65.7798V62.8135C115.679 56.8622 111.333 52.0361 105.98 52.0361H94.6562C89.3028 52.0361 84.957 56.8622 84.957 62.8135V65.7798" stroke="#2A2A2A" stroke-width="7.0625" stroke-linecap="round" stroke-linejoin="round" style={{"mix-blend-mode":"hard-light"}}/>
                    </svg>
